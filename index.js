...
class TamagModel {
    ...
    static get SOCIALIZATION_FUNC_NAME() { return 'go to bar' };
    ...
    executeAction(action) {
        switch (action) {
            ...
            case TamagModel.HEALTH_FUNC_NAME:
                return this._health();
            case TamagModel.SOCIALIZATION_FUNC_NAME:
    ...
    getStats() {
        return [
            new TamagDto(this.eatStat, 'Food', TamagModel.EAT_FUNC_NAME ),
            new TamagDto(this.happyStat, 'Happiness', TamagModel.HAPPY_FUNC_NAME ),
            ...
            new TamagDto(this.socializationStat, 'Socialization', TamagModel.SOCIALIZATION_FUNC_NAME ),
            new TamagDto(this.moneyStat, 'Money', TamagModel.MONEY_FUNC_NAME ),
            new TamagDto( '', 'Click this button' , TamagModel.BUYFOOD_FUNC_NAME ),
            new TamagDto( '', 'Click this button' , TamagModel.STARTBUSINESS_FUNC_NAME ),
        ]
    }
...
class TamagNinjaController extends TamgControllerAbstract {
    ...
    constructor(temagView, tamagModel, main) {
        super(temagView, tamagModel, main);
...
class TamagFactory {
    ...
    static get NINJA_TYPE() { return 'ninja (hard level)' };
    ...
    static getGameByType(type, main) {
        ...
        switch (type) {
            ...
            case TamagFactory.NINJA_TYPE:
                    return new TamagNinjaController(tamagView, new TamagModel(500), main);
            default:
